...
process.Fixed_EmitRealistic5TeVppCollision2017VtxSmearingParameters = cms.PSet(
    Alpha = cms.double(0.0),
    BetaStar = cms.double(311),
    Emittance = cms.double(7.6e-08),
    Phi = cms.double(0.0),
...
process.HGCAL_cceParams_toUse = cms.PSet(
    cceParamFine = cms.vdouble(3.5e+15, -3.428571e-17, 0.263812),
...
process.LHCTransport = cms.EDProducer("PPSSimTrackProducer",
    ...
    BeamDivergenceX = cms.double(47.32),
    BeamDivergenceY = cms.double(47.25),
    BeamEnergy = cms.double(7000.0),
    BeamEnergyDispersion = cms.double(0.001),
    BeamSigmaX = cms.double(7.08),
    BeamSigmaY = cms.double(7.09),
    BeamXatIP = cms.untracked.double(-0.75),
    BeamYatIP = cms.untracked.double(0.0),
    ...
    halfCrossingAngleXSector45 = cms.double(0.04),
    halfCrossingAngleXSector56 = cms.double(0.15),
    halfCrossingAngleYSector45 = cms.double(250.1),
    halfCrossingAngleYSector56 = cms.double(-250.0),
...
process.AntiBnoughtee = cms.EDFilter("PythiaDauVFilter",
...
process.AntiBnoughtmumu = cms.EDFilter("PythiaDauVFilter",
...
process.Bnoughtee = cms.EDFilter("PythiaDauVFilter",
    DaughterIDs = cms.untracked.vint32(11, -11),
    MaxEta = cms.untracked.vdouble(1.5, 1.5),
    MinEta = cms.untracked.vdouble(-1.5, -1.5),
    MinPt = cms.untracked.vdouble(3.0, 3.0),
...
process.Bnoughtmumu = cms.EDFilter("PythiaDauVFilter",
    DaughterIDs = cms.untracked.vint32(13, -13),
    MaxEta = cms.untracked.vdouble(2.5, 2.5),
    MinEta = cms.untracked.vdouble(-2.5, -2.5),
    MinPt = cms.untracked.vdouble(2.0, 2.0),
...
process.genstepfilter = cms.EDFilter("TriggerResultsFilter",
    ...
    triggerConditions = cms.vstring(
        'BnoughteeAntiBnoughtmumu', 
        'BnoughtmumuAntiBnoughtee', 
        'BnoughtmumuAntiBnoughtmumu', 
        'BnoughteeAntiBnoughtee'
    )
)
...
process.GlobalTag = cms.ESSource("PoolDBESSource",
    ...
    globaltag = cms.string('112X_mcRun3_2021_realistic_v15'),
...
process.BnoughteeAntiBnoughtmumu = cms.Path(process.filterBnoughteeAntiBnoughtmumu+process.pgen)


process.BnoughtmumuAntiBnoughtee = cms.Path(process.filterBnoughtmumuAntiBnoughtee+process.pgen)


process.BnoughtmumuAntiBnoughtmumu = cms.Path(process.filterBnoughtmumuAntiBnoughtmumu+process.pgen)


process.BnoughteeAntiBnoughtee = cms.Path(process.filterBnoughteeAntiBnoughtee+process.pgen)
...
process.schedule = cms.Schedule(*[ process.BnoughteeAntiBnoughtmumu, process.BnoughtmumuAntiBnoughtee, process.BnoughtmumuAntiBnoughtmumu, process.BnoughteeAntiBnoughtee, process.genfiltersummary_step, process.simulation_step, process.endjob_step, process.RAWSIMoutput_step ], tasks=[process.patAlgosToolsTask])
