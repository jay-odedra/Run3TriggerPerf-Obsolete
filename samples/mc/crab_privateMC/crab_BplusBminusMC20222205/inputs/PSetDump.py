...
process.Bminusee = cms.EDFilter("PythiaDauVFilter",
...
process.Bminusmumu = cms.EDFilter("PythiaDauVFilter",
...
process.Bplusee = cms.EDFilter("PythiaDauVFilter",
    DaughterIDs = cms.untracked.vint32(11, -11),
    MaxEta = cms.untracked.vdouble(1.5, 1.5),
    MinEta = cms.untracked.vdouble(-1.5, -1.5),
    MinPt = cms.untracked.vdouble(3.0, 3.0),
...
process.Bplusmumu = cms.EDFilter("PythiaDauVFilter",
    DaughterIDs = cms.untracked.vint32(13, -13),
    MaxEta = cms.untracked.vdouble(2.5, 2.5),
    MinEta = cms.untracked.vdouble(-2.5, -2.5),
    MinPt = cms.untracked.vdouble(2.0, 2.0),
...
process.BpluseeBminusmumu = cms.Path(process.filterBpluseeBminusmumu+process.pgen)


process.BplusmumuBminusee = cms.Path(process.filterBplusmumuBminusee+process.pgen)


process.BplusmumuBminusmumu = cms.Path(process.filterBplusmumuBminusmumu+process.pgen)


process.BpluseeBminusee = cms.Path(process.filterBpluseeBminusee+process.pgen)
...
process.schedule = cms.Schedule(*[ process.BpluseeBminusmumu, process.BplusmumuBminusee, process.BplusmumuBminusmumu, process.BpluseeBminusee, process.genfiltersummary_step, process.simulation_step, process.endjob_step, process.RAWSIMoutput_step ], tasks=[process.patAlgosToolsTask])
