...
# with command line options: --python_filename PPD-Run3Summer22MiniAODv3-00002_1_cfg.py --eventcontent RECOSIM,MINIAODSIM --customise Configuration/DataProcessing/Utils.addMonitoring --datatier GEN-SIM-RECO,MINIAODSIM --fileout file:PPD-Run3Summer22MiniAODv3-00002.root --conditions 124X_mcRun3_2022_realistic_v11 --step RAW2DIGI,L1Reco,RECO,RECOSIM,PAT --geometry DB:Extended --filein file:PPD-Run3Summer22DR-00001.root --era Run3 --no_exec --mc -n 100
...
process.source = cms.Source("PoolSource",
    fileNames = cms.untracked.vstring('file:root://cmsxrootd.fnal.gov///store/user/jodedra/BuTOKEE20220826bettersplitting/BuTOKEE20220826bettersplitting/SUMMER22_HLTRAW/220828_190934/0000/PPD-Run3Summer22DR-00001_0_1.root'),
...
#    ),
#    fileName = cms.untracked.string('file:PPD-Run3Summer22MiniAODv3-00002.root'),
...
process.MINIAODSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:PPD-Run3Summer22MiniAODv3-00002_inMINIAODSIM.root'),
